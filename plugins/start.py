        ...
        for i in range(1):
            ...
            try:
                if snt_msgs:
                    ...
                    await message.reply_photo(f"<b>⌯ ʏᴏᴜʀ ʟɪɴᴋ ɪꜱ ʀᴇᴀᴅʏ, ᴋɪɴᴅʟʏ ᴄʟɪᴄᴋ ᴏɴ ᴅᴏᴡɴʟᴏᴀᴅ ʙᴜᴛᴛᴏɴ..</b>", reply_markup=InlineKeyboardMarkup(btn), protect_content=False, quote=True)
                    return
